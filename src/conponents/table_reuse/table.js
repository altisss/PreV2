...
import { TABLE_TEMPLATE_01 } from './table_template'
// import PerfectScrollbar from 'react-perfect-scrollbar';
export default class TableReuse extends PureComponent {
    constructor(props) {
        super(props);
    ...
    render() {
        const { t } = this.props;
        const { headCells, rowAttr} = TABLE_TEMPLATE_01
        const data = this.props.data
        const RowFunction = this.props.rowfunction
        return (
